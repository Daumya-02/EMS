...
const FailedTask = ({data}) => {
  return (
    <div className='bg-orange-200 flex-shrink-0 w-full sm:w-[48%] md:w-[32%] lg:w-[24%] h-full rounded-xl p-5 min-h-[325px] '>
            ...
            <h2 className='text-2xl sm:text-3xl mt-2 font-semibold text-orange-600 pl-3'>{data.title}</h2>
            ...
            <div className='mt-2'>
                <button className='bg-red-400 w-full py-1 px-2 cursor-auto text-md font-medium text-black'>Failed</button>
            </div>
    </div>
  )
}
